package io.lhj.rpcfx.client;


import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.parser.ParserConfig;
import io.lhj.rpcfx.api.*;
import io.lhj.rpcfx.exception.ExecuteException;
...
public final class Rpcfx {
    ...
    private static final String nettyUrl = "http://localhost:8088";
    ...
    public static class RpcfxInvocationHandler implements InvocationHandler {
        ...
        public <T> RpcfxInvocationHandler(Class<T> serviceClass, String serverUrl, Filter... filters) {
        ...
        public Object invoke(Object proxy, Method method, Object[] params) throws Throwable {
            ...
            if(response.isSuccess()){
                ...
                log.error("[RPC调用异常，异常代码{}，异常原因{}]" , exception.code , exception.message);
                //如果自定的异常RpcException继承了Exception，进行反序列化时会报错，并且异常的对象很大，会导致传输慢，因此再封装一层异常
                throw new ExecuteException(exception.message , exception.getCode());
            }
        }
