package foreignexchange.account.userA.service;
...
import foreignexchange.account.userA.mapper.AccountDAO;
 ...
 */
@Slf4j
@org.springframework.stereotype.Service("userAAccountService")
@Service(version = "1.0.0", group = "userA")
